...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        ...
        factory(exports, require("./common/tool"), require("./api"), require("./common/base64"));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.tool, global.api, global.base64);
        global.index = mod.exports;
    }
})(this, function (exports, _tool, _api, _base) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.setDmp = exports.isWeixin = exports.getUserInfo = exports.getOpenid = exports.initWechatJSSDK = exports.initWechatShare = undefined;
     ...
     */
    var initWechatShare = exports.initWechatShare = function initWechatShare(options) {
        return initWechatJSSDK({ jsApiList: config.jsApiList }).then(function (wx) {
            var cfg = (0, _tool._extends)({
     ...
     * @returns {Promise}
     */
    var initWechatJSSDK = exports.initWechatJSSDK = function initWechatJSSDK(_ref2) {
    ...
    function auth() {
        ...
        var user = (0, _tool.getCookie)('wxuser'),
            userInfo = null;
        if (user) {
        ...
        var openid = (0, _tool.getCookie)('openid') || (0, _tool.getUrlParam)('openid');
        if (!openid && userInfo) {
     ...
     * @param dmpStatus
     */
    var setDmp = exports.setDmp = function setDmp(dmpStatus) {
        dmp = dmpStatus;
    };
});
