//@copyright Lenovo service wechat jssdk, version: 0.2.7
/**
 * 脚本按需加载
 * @param source
 * @returns {Promise}
...
function auth() {
    ...
    var jumpUrl = ['https://weixin.lenovo.com.cn/service/gateway/'];
...
export { initWechatShare, initWechatJSSDK, getOpenid, getUserInfo, isWeixin, setDmp };
